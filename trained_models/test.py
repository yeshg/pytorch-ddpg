...
if args.algo_name == "DDPG":
    agent = DDPG(gamma=0.99, tau=0.001, hidden_size=256,
                num_inputs=env.observation_space.shape[0], action_space=env.action_space, max_action=float(env.action_space.high[0]), min_action=float(env.action_space.low[0]))
